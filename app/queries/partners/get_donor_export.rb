    ...
    def call(partner:)
      ...
      @relation
        ...
        .select(
          ...
          "COALESCE(managed_portfolios.name, 'Unmanaged Portfolio') AS portfolio",
          :frequency,
          'CAST(CAST(amount_cents / 100.0 AS DECIMAL(10,2)) AS VARCHAR) AS contribution_amount',
          'start_at AS contributions_start_date',
          'recurring_contributions.deactivated_at AS contributions_stop_date',
