module Onboarding
  class ImportanceOfGlobalHealth < QuickResponseStep
    ...
    message "I'd like to know what issue areas matter most to you. We'll use this decide which charities to include in your portfolio"
    message "On a scale from 1-5, how important are the following issues:"
