    ...
    return function(a) {
        ...
        (function(Ra) {
            ...
            e = function() {
                ...
                var r = l.momentProperties = [];
                function p(e, t) {
                    var a,
                        n,
                        s;
                    if (o(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), o(t._i) || (e._i = t._i), o(t._f) || (e._f = t._f), o(t._l) || (e._l = t._l), o(t._strict) || (e._strict = t._strict), o(t._tzm) || (e._tzm = t._tzm), o(t._isUTC) || (e._isUTC = t._isUTC), o(t._offset) || (e._offset = t._offset), o(t._pf) || (e._pf = y(t)), o(t._locale) || (e._locale = t._locale), 0 < r.length)
                ...
                function F(e, t, a) {
                    var n = "" + Math.abs(e),
                        s = t - n.length;
                    return (0 <= e ? a ? "+" : "" : "-") + Math.pow(10, Math.max(0, s)).toString().substr(1) + n
                }
                ...
                ve = Array.prototype.indexOf ? Array.prototype.indexOf : function(e) {
                    ...
                    null != s ? t[Me] = s : y(a).invalidMonth = e
                });
                var xe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
                ...
                function Je(e, t, a, n, s) {
                    var r,
                        i,
                        d = 1 + 7 * (t - 1) + (7 + a - n) % 7 + Ne(e, n, s);
                    return d <= 0 ? i = Te(r = e - 1) + d : d > Te(e) ? (r = e + 1, i = d - Te(e)) : (r = e, i = d), {
                        year: r,
                        dayOfYear: i
                    }
                }
                function Re(e, t, a) {
                    ...
                    return i < 1 ? n = i + Ie(s = e.year() - 1, t, a) : i > Ie(e.year(), t, a) ? (n = i - Ie(e.year(), t, a), s = e.year() + 1) : (s = e.year(), n = i), {
                        week: n,
                        year: s
                    }
                }
                ...
                R("H", ["HH", 2], 0, "hour"), R("h", ["hh", 2], 0, Ze), R("k", ["kk", 2], 0, function() {
                    ...
                    var n = e.length - 2;
                    t[ye] = g(e.substr(0, n)), t[Ye] = g(e.substr(n)), y(a).bigHour = !0
                }), le("hmmss", function(e, t, a) {
                    var n = e.length - 4,
                        s = e.length - 2;
                    t[ye] = g(e.substr(0, n)), t[Ye] = g(e.substr(n, 2)), t[fe] = g(e.substr(s)), y(a).bigHour = !0
                }), le("Hmm", function(e, t, a) {
                    var n = e.length - 2;
                    t[ye] = g(e.substr(0, n)), t[Ye] = g(e.substr(n))
                }), le("Hmmss", function(e, t, a) {
                    var n = e.length - 4,
                        s = e.length - 2;
                    t[ye] = g(e.substr(0, n)), t[Ye] = g(e.substr(n, 2)), t[fe] = g(e.substr(s))
                });
                var et,
                    tt = be("Hours", !0),
                    at = {
                ...
                function it(e) {
                    var t = null;
                    if (!nt[e] && void 0 !== Ra && Ra && Ra.exports)
                        try {
                            t = et._abbr;
                            Ia(127)("./" + e), dt(t)
                        } catch (e) {}
                ...
                function dt(e, t) {
                    var a;
                    return e && ((a = o(t) ? ot(e) : _t(e, t)) ? et = a : "undefined" != typeof console && console.warn && console.warn("Locale " + e + " not found. Did you forget to load it?")), et._abbr
                }
                function _t(e, t) {
                    if (null !== t) {
                        var a,
                        ...
                        if (t.abbr = e, null != nt[e])
                            b("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), n = nt[e]._config;
                        else if (null != t.parentLocale)
                            if (null != nt[t.parentLocale])
                                n = nt[t.parentLocale]._config;
                            else {
                                if (null == (a = it(t.parentLocale)))
                    ...
                    return function(e) {
                        for (var t, a, n, s, r = 0; r < e.length;) {
                            for (t = (s = rt(e[r]).split("-")).length, a = (a = rt(e[r + 1])) ? a.split("-") : null; 0 < t;) {
                                if (n = it(s.slice(0, t).join("-")))
                                    return n;
                                if (a && a.length >= t && i(s, a, !0) >= t - 1)
                                    break;
                                t--
                            }
                            r++
                ...
                function ut(e) {
                    var t,
                        a = e._a;
                    return a && -2 === y(e).overflow && (t = a[Me] < 0 || 11 < a[Me] ? Me : a[Le] < 1 || a[Le] > je(a[ce], a[Me]) ? Le : a[ye] < 0 || 24 < a[ye] || 24 === a[ye] && (0 !== a[Ye] || 0 !== a[fe] || 0 !== a[pe]) ? ye : a[Ye] < 0 || 59 < a[Ye] ? Ye : a[fe] < 0 || 59 < a[fe] ? fe : a[pe] < 0 || 999 < a[pe] ? pe : -1, y(e)._overflowDayOfYear && (t < ce || Le < t) && (t = Le), y(e)._overflowWeeks && -1 === t && (t = ke), y(e)._overflowWeekday && -1 === t && (t = De), y(e).overflow = t), e
                }
                function mt(e, t, a) {
                ...
                function lt(e) {
                    ...
                    if (!e._d) {
                        var d,
                            _;
                        for (d = e, _ = new Date(l.now()), n = d._useUTC ? [_.getUTCFullYear(), _.getUTCMonth(), _.getUTCDate()] : [_.getFullYear(), _.getMonth(), _.getDate()], e._w && null == e._a[Le] && null == e._a[Me] && function(e) {
                            var t,
                                a,
                                n,
                                s,
                            ...
                            if (null != (t = e._w).GG || null != t.W || null != t.E)
                                r = 1, i = 4, a = mt(t.GG, e._a[ce], Re(bt(), 1, 4).year), n = mt(t.W, 1), ((s = mt(t.E, 1)) < 1 || 7 < s) && (_ = !0);
                            else {
                                r = e._locale._week.dow, i = e._locale._week.doy;
                                var o = Re(bt(), r, i);
                                a = mt(t.gg, e._a[ce], o.year), n = mt(t.w, o.week), null != t.d ? ((s = t.d) < 0 || 6 < s) && (_ = !0) : null != t.e ? (s = t.e + r, (t.e < 0 || 6 < t.e) && (_ = !0)) : s = r
                            }
                        ...
                        24 === e._a[ye] && 0 === e._a[Ye] && 0 === e._a[fe] && 0 === e._a[pe] && (e._nextDay = !0, e._a[ye] = 0), e._d = (e._useUTC ? Ce : function(e, t, a, n, s, r, i) {
                            ...
                            return e < 100 && 0 <= e && isFinite(d.getFullYear()) && d.setFullYear(e), d
                ...
                function kt(e, t, a, n, s, r) {
                    var i = [function(e) {
                        ...
                        return t
                    }(e), Oe.indexOf(t), parseInt(a, 10), parseInt(n, 10), parseInt(s, 10)];
                ...
                function Tt(e) {
                    ...
                    if (s) {
                        var r = kt(s[4], s[3], s[2], s[5], s[6], s[7]);
                        if (t = s[1], a = r, n = e, t && Ue.indexOf(t) !== new Date(a[0], a[1], a[2]).getDay() && (y(n).weekdayMismatch = !0, !(n._isValid = !1)))
                            return;
                        e._a = r, e._tzm = function(e, t, a) {
                            if (e)
                                return Dt[e];
                            if (t)
                                return 0;
                    ...
                    if (e._f !== l.ISO_8601)
                        if (e._f !== l.RFC_2822) {
                            ...
                            var t,
                                ...
                                u = o.length,
                                m = 0;
                            for (n = G(e._f, e._locale).match(z) || [], t = 0; t < n.length; t++)
                            ...
                            y(e).charsLeftOver = u - m, 0 < o.length && y(e).unusedInput.push(o), e._a[ye] <= 12 && !0 === y(e).bigHour && 0 < e._a[ye] && (y(e).bigHour = void 0), y(e).parsedDateParts = e._a.slice(0), y(e).meridiem = e._meridiem, e._a[ye] = function(e, t, a) {
                                ...
                                if (null == a)
                                    return t;
                                return null != e.meridiemHour ? e.meridiemHour(t, a) : (null != e.isPM && ((n = e.isPM(a)) && t < 12 && (t += 12), n || 12 !== t || (t = 0)), t)
                ...
                function vt(e) {
                    var t,
                        ...
                        r = e._i,
                        i = e._f;
                    return e._locale = e._locale || ot(e._l), null === r || void 0 === i && "" === r ? f({
                        nullInput: !0
                    }) : ("string" == typeof r && (e._i = r = e._locale.preparse(r)), D(r) ? new k(ut(r)) : (m(r) ? e._d = r : d(i) ? function(e) {
                        var t,
                            a,
                            n,
                            s,
                ...
                function wt(e, t, a, n, s) {
                    var r,
                        i = {};
                    return !0 !== a && !1 !== a || (n = a, a = void 0), (_(e) && function(e) {
                ...
                var St = a("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
                ...
                function zt(e, t) {
                    var a,
                        n;
                    return t._isUTC ? (a = t.clone(), n = (D(e) || m(e) ? e.valueOf() : bt(e).valueOf()) - a.valueOf(), a._d.setTime(a._d.valueOf() + n), l.updateOffset(a, !1), a) : bt(e).local()
                }
                function Ct(e) {
                ...
                function It(e, t) {
                    ...
                    return Ot(e) ? r = {
                        ...
                        d: e._days,
                        M: e._months
                    } : u(e) ? (r = {}, t ? r[t] = e : r.milliseconds = e) : (i = Jt.exec(e)) ? (a = "-" === i[1] ? -1 : 1, r = {
                        y: 0,
                        d: g(i[Le]) * a,
                        h: g(i[ye]) * a,
                        m: g(i[Ye]) * a,
                        ...
                        t = zt(t, e), e.isBefore(t) ? a = Ut(e, t) : ((a = Ut(t, e)).milliseconds = -a.milliseconds, a.months = -a.months);
                        return a
                ...
                function Vt(n, s) {
                    return function(e, t) {
                        var a;
                        return null === t || isNaN(+t) || (b(s, "moment()." + s + "(period, number) is deprecated. Please use moment()." + s + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), a = e, e = t, t = a), qt(this, It(e = "string" == typeof e ? +e : e, t), n), this
                    }
                }
                function qt(e, t, a, n) {
                    var s = t._milliseconds,
                        r = Wt(t._days),
                        i = Wt(t._months);
                    e.isValid() && (n = null == n || n, i && We(e, Se(e, "Month") + i * a), r && He(e, "Date", Se(e, "Date") + r * a), s && e._d.setTime(e._d.valueOf() + s * a), n && l.updateOffset(e, r || i))
                }
                ...
                var Qt = a("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function(e) {
                ...
                function ta(e, t, a, n, s) {
                    var r;
                    return null == e ? Re(this, n, s).year : ((r = Ie(e, n, s)) < t && (t = r), function(e, t, a, n, s) {
                        var r = Je(e, t, a, n, s),
                ...
                var aa = be("Date", !0);
                R("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), P("dayOfYear", "DDD"), A("dayOfYear", 4), _e("DDD", X), _e("DDDD", q), le(["DDD", "DDDD"], function(e, t, a) {
                    a._dayOfYear = g(e)
                }), R("m", ["mm", 2], 0, "minute"), P("minute", "m"), A("minute", 14), _e("m", $), _e("mm", $, V), le(["m", "mm"], Ye);
                var na = be("Minutes", !1);
                R("s", ["ss", 2], 0, "second"), P("second", "s"), A("second", 15), _e("s", $), _e("ss", $, V), le(["s", "ss"], fe);
                var sa,
                    ra = be("Seconds", !1);
                ...
                _a.add = Bt, _a.calendar = function(e, t) {
                    var a = e || bt(),
                        ...
                        r = t && (S(t[s]) ? t[s].call(this, a) : t[s]);
                    return this.format(r || this.localeData().calendar(s, this, bt(a)))
                }, _a.clone = function() {
                    return new k(this)
                    ...
                    return this.isValid() && (D(e) && e.isValid() || bt(e).isValid()) ? It({
                        to: this,
                        from: e
                    ...
                    var a = D(e) ? e : bt(e);
                    return !(!this.isValid() || !a.isValid()) && ("millisecond" === (t = O(o(t) ? "millisecond" : t)) ? this.valueOf() > a.valueOf() : a.valueOf() < this.clone().startOf(t).valueOf())
                }, _a.isBefore = function(e, t) {
                    var a = D(e) ? e : bt(e);
                    return !(!this.isValid() || !a.isValid()) && ("millisecond" === (t = O(o(t) ? "millisecond" : t)) ? this.valueOf() < a.valueOf() : this.clone().endOf(t).valueOf() < a.valueOf())
                    ...
                    return a.year() < 0 || 9999 < a.year() ? I(a, t ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : S(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", I(a, "Z")) : I(a, t ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
                }, _a.inspect = function() {
                    if (!this.isValid())
                    ...
                    return null != e ? (t = e, a = this.localeData(), e = "string" != typeof t ? t : isNaN(t) ? "number" == typeof (t = a.weekdaysParse(t)) ? t : null : parseInt(t, 10), this.add(e - n, "d")) : n
                    ...
                    if (!this.isValid())
                        return null != e ? this : NaN;
                    if (null != e) {
                        var t = (a = e, n = this.localeData(), "string" == typeof a ? n.weekdaysParse(a) % 7 || 7 : isNaN(a) ? null : a);
                    ...
                    if (null != e) {
                        ...
                        return !this._isUTC && t && (n = Ct(this)), this._offset = e, this._isUTC = !0, null != n && this.add(n, "m"), s !== e && (!t || this._changeInProgress ? qt(this, It(e - s, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, l.updateOffset(this, !0), this._changeInProgress = null)), this
                    }
                ...
                function ha(e, t, a, n) {
                    "boolean" == typeof e ? u(t) && (a = t, t = void 0) : (t = e, e = !1, u(a = t) && (a = t, t = void 0)), t = t || "";
                    var s,
                        r = ot(),
                        i = e ? r._week.dow : 0;
                    if (null != a)
                ...
                }), l.lang = a("moment.lang is deprecated. Use moment.locale instead.", dt), l.langData = a("moment.langData is deprecated. Use moment.localeData instead.", ot);
                var ca = Math.abs;
                function Ma(e, t, a, n) {
                    var s = It(t, a);
                ...
                return Ja.isValid = function() {
                    ...
                    if ("month" === (e = O(e)) || "year" === e)
                        return t = this._days + n / 864e5, a = this._months + ya(t), "month" === e ? a : a / 12;
                    ...
                    var e,
                        ...
                        d = this._months,
                        _ = this._data;
                    return 0 <= r && 0 <= i && 0 <= d || r <= 0 && i <= 0 && d <= 0 || (r += 864e5 * La(Ya(d) + i), d = i = 0), _.milliseconds = r % 1e3, e = T(r / 1e3), _.seconds = e % 60, t = T(e / 60), _.minutes = t % 60, a = T(t / 60), _.hours = a % 24, d += s = T(ya(i += T(a / 24))), i -= La(Ya(s)), n = T(d / 12), d %= 12, _.days = i, _.months = d, _.years = n, this
                }, Ja.clone = function() {
                    return It(this)
                }, Ja.get = function(e) {
                    ...
                    return e && (h = l.pastFuture(+this, h)), l.postformat(h)
                    ...
                    if (null != t) {
                        var a,
                            n,
                            s = at;
                        null != (n = it(e)) && (s = n._config), (a = new j(t = H(s, t))).parentLocale = nt[e], nt[e] = a, dt(e)
                    } else
            ...
            var t = {
                ...
                n = function(i) {
                    return function(e, t, a, n) {
                        var s = d(e),
                            r = _[i][d(e)];
                        return 2 === s && (r = r[t ? 0 : 1]), r.replace(/%d/i, e)
                    }
                },
            ...
            e.defineLocale("az", {
                ...
                ordinal: function(e) {
                    if (0 === e)
                        return e + "-ıncı";
                    var t = e % 10;
                    return e + (a[t] || a[e % 100 - t] || a[100 <= e ? 100 : null])
                },
                week: {
                    dow: 1,
                    doy: 7
        ...
        (function(e) {
            ...
            function t(e, t, a) {
                ...
                return "m" === a ? t ? "хвіліна" : "хвіліну" : "h" === a ? t ? "гадзіна" : "гадзіну" : e + " " + (n = +e, s = {
                    ...
                    yy: "год_гады_гадоў"
                }[a].split("_"), n % 10 == 1 && n % 100 != 11 ? s[0] : 2 <= n % 10 && n % 10 <= 4 && (n % 100 < 10 || 20 <= n % 100) ? s[1] : s[2])
            }
            e.defineLocale("be", {
                months: {
        ...
        (function(e) {
            ...
            e.defineLocale("bg", {
                ...
                ordinal: function(e) {
                    var t = e % 10,
                        a = e % 100;
                    return 0 === e ? e + "-ев" : 0 === a ? e + "-ен" : 10 < a && a < 20 ? e + "-ти" : 1 === t ? e + "-ви" : 2 === t ? e + "-ри" : 7 === t || 8 === t ? e + "-ми" : e + "-ти"
                },
                week: {
                    dow: 1,
                    doy: 7
        ...
        (function(e) {
            ...
            var d = "nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän".split(" "),
                _ = ["nolla", "yhden", "kahden", "kolmen", "neljän", "viiden", "kuuden", d[7], d[8], d[9]];
            function t(e, t, a, n) {
                var s,
                    r,
                    i = "";
                ...
                return r = n, i = ((s = e) < 10 ? r ? _[s] : d[s] : s) + " " + i
            }
            e.defineLocale("fi", {
        ...
        (function(e) {
            ...
            function t(e, t, a, n) {
                ...
                case "ss":
                    return r(e) ? s + (t || n ? "sekúndur" : "sekúndum") : s + "sekúnda";
                case "m":
                    return t ? "mínúta" : "mínútu";
                case "mm":
                    return r(e) ? s + (t || n ? "mínútur" : "mínútum") : t ? s + "mínúta" : s + "mínútu";
                case "hh":
                    return r(e) ? s + (t || n ? "klukkustundir" : "klukkustundum") : s + "klukkustund";
                case "d":
                    return t ? "dagur" : n ? "dag" : "degi";
                case "dd":
                    return r(e) ? t ? s + "dagar" : s + (n ? "daga" : "dögum") : t ? s + "dagur" : s + (n ? "dag" : "degi");
                case "M":
                    return t ? "mánuður" : n ? "mánuð" : "mánuði";
                case "MM":
                    return r(e) ? t ? s + "mánuðir" : s + (n ? "mánuði" : "mánuðum") : t ? s + "mánuður" : s + (n ? "mánuð" : "mánuði");
                case "y":
                    return t || n ? "ár" : "ári";
                case "yy":
        ...
        (function(e) {
            ...
            function a(e, t, a, n) {
                var s = e + " ";
                return 1 === e ? s + r(0, t, a[0], n) : t ? s + (i(e) ? d(a)[1] : d(a)[0]) : n ? s + d(a)[1] : s + (i(e) ? d(a)[1] : d(a)[2])
            }
            e.defineLocale("lt", {
                months: {
        ...
        (function(e) {
            ...
            var s = {
                ...
                translate: function(e, t, a) {
                    var n = s.words[a];
                    return 1 === a.length ? t ? n[0] : n[1] : e + " " + s.correctGrammaticalCase(e, n)
                }
            };
            e.defineLocale("me", {
        ...
        (function(e) {
            ...
            function n(e, t, a, n) {
                ...
                case "ss":
                    return t || n ? s + (r(e) ? "sekundy" : "sekúnd") : s + "sekundami";
                case "m":
                    return t ? "minúta" : n ? "minútu" : "minútou";
                case "mm":
                    return t || n ? s + (r(e) ? "minúty" : "minút") : s + "minútami";
                case "h":
                    return t ? "hodina" : n ? "hodinu" : "hodinou";
                case "hh":
                    return t || n ? s + (r(e) ? "hodiny" : "hodín") : s + "hodinami";
                case "d":
                    return t || n ? "deň" : "dňom";
                case "dd":
                    return t || n ? s + (r(e) ? "dni" : "dní") : s + "dňami";
                case "M":
                    return t || n ? "mesiac" : "mesiacom";
                case "MM":
                    return t || n ? s + (r(e) ? "mesiace" : "mesiacov") : s + "mesiacmi";
                case "y":
                ...
                ordinal: function(e, t) {
                    ...
                    default:
                        if (0 === e)
                            return e + "'ıncı";
                        var a = e % 10;
                        return e + (n[a] || n[e % 100 - a] || n[100 <= e ? 100 : null])
                    }
                },
                week: {
                    dow: 1,
        ...
        var k = function(e) {
            function s(e) {
                ...
                if (a.element = r.a(e) ? document.querySelector(e) : e, !a.element)
                    throw new Error("An invalid selector or non-DOM node has been provided.");
                return a._clickEvents = ["click"], a.options = o({}, d.a, t), a[m] = a[m].bind(a), a[l] = a[l].bind(a), a[h] = a[h].bind(a), a[c] = a[c].bind(a), a[M] = a[M].bind(a), a[y] = a[y].bind(a), a[Y] = a[Y].bind(a), a[f] = a[f].bind(a), a._init(), a
            }
            return function(e, t) {
                ...
                value: function() {
                    if (this.element.value ? "date" === this.element.getAttribute("type").toLowerCase() ? this.date = L()(this.element.value, "YYYY-MM-DD") : this.date = L()(this.element.value) : this.date = this.options.selectedDate ? L()(this.options.selectedDate) : L()(), this.minDate = this.options.minDate ? L()(this.options.minDate) : null, this.maxDate = this.options.maxDate ? L()(this.options.maxDate) : null, this.options.disabledDates) {
                        ...
                        for (var e = 0; e < this.options.disabledDates.length; e++)
                ...
                key: "_build",
                value: function() {
                    var e = document.createRange().createContextualFragment(Object(_.a)(o({}, this.options, {
                        id: this.id,
                        date: this.date,
                        month: L.a.months()[this.date.month()],
                        getDayName: this[f]
                    })));
                ...
                value: function() {
                    var a = this;
                    [].forEach.call(this.elementCalendarDays, function(t) {
                ...
                value: function(e) {
                    var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                    for (e += "number" != typeof this.options.weekStart && 0 <= this.options.weekStart && this.options.weekStart <= 6 ? this.options.weekStart : this.lang.weekStart; 7 <= e;)
                        e -= 7;
                    return t ? L.a.weekdaysShort()[e] : L.a.weekdays()[e]
                }
            }, {
                key: "_renderDay",
                value: function(e, t, a, n, s, r, i, d, _, o) {
                    return '\n      <div data-date="' + L()({
                        year: a,
                        month: t,
                        day: e
                    }).format(this.dateFormat).toString() + '" class="calendar-date' + (r ? " is-disabled" : "") + (d ? " calendar-range" : "") + (_ ? " calendar-range-start" : "") + (o ? " calendar-range-end" : "") + '">\n        <button class="date-item' + (s ? " is-today" : "") + (n ? " is-active" : "") + '">' + e + "</button>\n      </div>\n    "
                }
            }, {
                key: "_renderDays",
                value: function() {
                    ...
                    console.log(L()().startOf("week").day()), console.log(L()().weekday(1).day());
                    var s = "number" != typeof this.options.weekStart && 0 <= this.options.weekStart && this.options.weekStart <= 6 ? this.options.weekStart : 1;
                    0 < s && (n -= s) < 0 && (n += 7);
                    for (var r = a + n, i = r; 7 < i;)
                        i -= 7;
                    r += 7 - i;
                    for (var d = 0; d < r; d++) {
                        var _ = L()().year(this.date.year()).month(this.date.month()).date(d - n + 1).hours(0).minutes(0).seconds(0).milliseconds(0),
                            ...
                            h = d < n || a + n <= d,
                            c = !1;
                        if (o || (m = u = !1), (_.month() !== this.date.month() || this.minDate && _.unix() < this.minDate.unix() || this.maxDate && _.unix() > this.maxDate.unix()) && (c = !0), this.options.disabledDates)
                            for (var M = 0; M < this.options.disabledDates.length; M++)
                ...
                value: function() {
                    var e = void 0,
                        t = void 0,
                        a = void 0;
                    if ("function" == typeof this.element.getBoundingClientRect)
                        e = (a = this.element.getBoundingClientRect()).left + window.pageXOffset, t = a.bottom + window.pageYOffset;
                    else
                        for (e = this.element.offsetLeft, t = this.element.offsetTop + this.element.offsetHeight; this.element = this.element.offsetParent;)
                ...
                set: function() {
                    ...
                    this._date = L()(e).hours(0).minutes(0).seconds(0).milliseconds(0)
                }
            }, {
                key: "minDate",
                get: function() {
                ...
                set: function() {
                    ...
                    this._minDate = e ? L()(e, this.dateFormat) : null
                }
            }, {
                key: "maxDate",
                get: function() {
                ...
                set: function() {
                    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null;
                    this._maxDate = e ? L()(e, this.dateFormat) : null
                }
            }, {
                key: "dateFormat",
                get: function() {
                ...
                value: function() {
                    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 'input[type="date"]',
                        ...
                        a = new Array,
                        n = r.a(e) ? document.querySelectorAll(e) : Array.isArray(e) ? e : [e];
        ...
        var s = function() {
            ...
            return n(t, [{
                ...
                value: function(a, n) {
                    ...
                    a = a.toString();
                    var i = this._listeners.get(a),
                        d = null,
                        _ = 0,
                        o = r;
                    if (Array.isArray(i))
                        for (i.forEach(function(e, t) {
        ...
        "use strict";
        t.a = function(e) {
					return "<div id='" + e.id + "' class=\"datepicker " + (e.overlay ? "modal" : "") + '">' + (e.overlay ? '<div class="modal-background"></div>' : "") + '<div class="calendar"> <div class="calendar-nav"> <div class="calendar-nav-year"> <button class="calendar-nav-previous-year button is-small is-text">' + e.icons.year.previous + '</button> <div class="calendar-year">' + e.date.year() + '</div> <button class="calendar-nav-next-year button is-small is-text">' + e.icons.year.next + '</button> </div> <div class="calendar-nav-month"> <button class="calendar-nav-previous-month button is-small is-text">' + e.icons.month.previous + '</button> <div class="calendar-month">' + e.month + '</div> <button class="calendar-nav-next-month button is-small is-text">' + e.icons.month.next + '</button> </div> <div class="calendar-nav-day"> <div class="calendar-day">' + e.date.day() + '</div> </div> </div> <div class="calendar-container"> <div class="calendar-header"> <div class="calendar-date">' + e.getDayName(0, !0) + '</div> <div class="calendar-date">' + e.getDayName(1, !0) + '</div> <div class="calendar-date">' + e.getDayName(2, !0) + '</div> <div class="calendar-date">' + e.getDayName(3, !0) + '</div> <div class="calendar-date">' + e.getDayName(4, !0) + '</div> <div class="calendar-date">' + e.getDayName(5, !0) + '</div> <div class="calendar-date">' + e.getDayName(6, !0) + '</div> </div> <div class="calendar-body"></div></div></div></div>';
				}
    }]).default
});
